...
namespace MotionSystems
{
	public class ForceSeatMI_UnityAeroplane
	{
		...
		public void Tick(Rigidbody body, float deltaTime, bool paused)
		{
			...
			{
				LowPassFilter(ref m_telemetry.surgeAcceleration, (m_telemetry.surgeSpeed - m_prevSurgeSpeed) / Time.deltaTime, FSMI_ACC_LOW_PASS_FACTOR);
				LowPassFilter(ref m_telemetry.swayAcceleration,  (m_telemetry.swaySpeed - m_prevSwaySpeed)   / Time.deltaTime, FSMI_ACC_LOW_PASS_FACTOR);
				LowPassFilter(ref m_telemetry.heaveAcceleration, (m_telemetry.heaveSpeed - m_prevHeaveSpeed) / Time.deltaTime, FSMI_ACC_LOW_PASS_FACTOR);
				...
				LowPassFilter(ref m_telemetry.rollSpeed,  deltaAngles.z / Time.deltaTime, FSMI_ANGLES_SPEED_LOW_PASS_FACTOR);
				LowPassFilter(ref m_telemetry.pitchSpeed, deltaAngles.x / Time.deltaTime, FSMI_ANGLES_SPEED_LOW_PASS_FACTOR);
				LowPassFilter(ref m_telemetry.yawSpeed,   deltaAngles.y / Time.deltaTime, FSMI_ANGLES_SPEED_LOW_PASS_FACTOR);
			}
